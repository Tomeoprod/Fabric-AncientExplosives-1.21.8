...
public record EntityOutlineRenderingS2CPacket(int ticks, int entityId, int r, int g, int b) implements CustomPayload{
    public static final Identifier CHESTPLATE_ACTIVATION_ID = Identifier.of(AncientExplosives.MOD_ID, "entity_outline_rendering");
    public static final Id<EntityOutlineRenderingS2CPacket> ID = new Id<>(CHESTPLATE_ACTIVATION_ID);
