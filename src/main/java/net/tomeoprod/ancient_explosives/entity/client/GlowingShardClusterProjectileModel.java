...
public class GlowingShardClusterProjectileModel extends EntityModel<EntityRenderState> {
	public static final EntityModelLayer GLOWING_SHARD_CLUSTER = new EntityModelLayer(Identifier.of(AncientExplosives.MOD_ID, "glowing_shard_cluster"), "main");
	private final ModelPart bb_main;


	public GlowingShardClusterProjectileModel(ModelPart root) {
        super(root);
