...
public class PaperParticle extends SpriteBillboardParticle {
    ...
    public PaperParticle(ClientWorld clientWorld, double x, double y, double z, SpriteProvider spriteProvider, double xSpeed, double ySpeed, double zSpeed) {
        super(clientWorld, x, y, z, xSpeed, ySpeed, zSpeed);

        this.scale = 0.1f + new Random().nextFloat(0.25f);
        this.maxAge = new Random().nextInt(100, 200);
        this.setSpriteForAge(spriteProvider);

        this.red = new Random().nextFloat();
        this.green = new Random().nextFloat();
        this.blue = new Random().nextFloat();
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new PaperParticle(world, x, y, z, this.spriteProvider, velocityX, velocityY, velocityZ);
        }
    }
}
