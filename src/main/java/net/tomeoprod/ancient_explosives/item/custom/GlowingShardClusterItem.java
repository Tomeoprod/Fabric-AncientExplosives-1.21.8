...
public class GlowingShardClusterItem extends Item {
    public GlowingShardClusterItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            GlowingShardClusterProjectileEntity shards = new GlowingShardClusterProjectileEntity(world, user);
